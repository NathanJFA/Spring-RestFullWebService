...
public class UserController {
	...
	// i can use required = false to make optional
	@GetMapping
	...
	public UserRest updateUser(@PathVariable String userId, @RequestBody UserDetailsRequestModel userDetails) {
		UserRest storageUserDetails = users.get(userId);
		storageUserDetails.setFirstName(userDetails.getFirstName());
		storageUserDetails.setLastName(userDetails.getLastName());
		users.put(userId, storageUserDetails);
		
		return storageUserDetails;
	}
